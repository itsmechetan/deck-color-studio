...
export async function generatePptx(
  ...
  ["Introduction", "Key Insights", "Data Analysis", "Recommendations", "Next Steps"].forEach((item, i) => {
    ...
    slide2.addShape("rect", { x: 0.5, y: 1.5 + i * 0.8, w: 0.3, h: 0.3, fill: { color: colors[i] } });
  ...
  for (let i = 8; i < deck.slideCount; i++) {
    ...
    slide.addShape("rect", { x: 0.5, y: 1.3, w: 9, h: 3.5, fill: { color: accentColors[i % 6], transparency: 92 } });
